...
public class ColorPickerPalette extends TableLayout {
    ...
    public void init(int size, int columns, ColorPickerSwatch.OnColorSelectedListener listener) {
        ...
        if (size == ColorPickerDialog.SIZE_LARGE) {
            mSwatchLength = res.getDimensionPixelSize(ColorPickerDialog.getID("color_swatch_large", "dimen", getContext()));
            mMarginSize = res.getDimensionPixelSize(ColorPickerDialog.getID("color_swatch_margins_large","dimen",getContext()));
        } else {
            mSwatchLength = res.getDimensionPixelSize(ColorPickerDialog.getID("color_swatch_small","dimen",getContext()));
            mMarginSize = res.getDimensionPixelSize(ColorPickerDialog.getID("color_swatch_margins_small", "dimen",getContext()));
        }
        mOnColorSelectedListener = listener;

        mDescription = res.getString(ColorPickerDialog.getID("color_swatch_description","string",getContext()));
        mDescriptionSelected = res.getString(ColorPickerDialog.getID("color_swatch_description_selected","string",getContext()));
    }
